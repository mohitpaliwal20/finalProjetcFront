...
const Store = () => {
    ...
    return (
      <>
        <Navbar />
        <div className="flex justify-between items-center bg-gray-900 text-white p-5 mb-12">
          <h1 className="text-4xl font-bold flex items-center">
            <FaCar className="mr-2 text-gray-400" /> Automotive Store
          </h1>
          <div className="flex items-center">
            {showSearch && (
              <input
                ...
                className="w-1/3 p-2 rounded border border-gray-300 bg-gray-200 text-black"
              />
            )}
            <div
              className="ml-4 text-2xl cursor-pointer text-gray-400 hover:text-white"
